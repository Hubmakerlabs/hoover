...
|**Signature-Type**|     The type of signature verification method used: `0` for Bluesky (no verification), `1` and `2` for Farcaster (`ED25519` and `EIP-712` respectively), `3` for Nostr (`Schnorr/SECP256K1`)                                                                                                                                                                                                                                                               |

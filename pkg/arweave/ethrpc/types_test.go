...
func TestTransactionUnmarshal(t *testing.T) {
	...
	require.Nil(t, err)
	require.Equal(t,
		"0x3003694478c108eaec173afcb55eafbb754a0b204567329f623438727ffa90d8",
		tx.BlockHash)
	...
	require.Equal(t,
		"0xfc7dcd42eb0b7898af2f52f7c5af3bd03cdf71ab8b3ed5b3d3a3ff0d91343cbe",
		tx.Hash)
	require.Equal(t,
		"0xe1fa8e8425f1af44eb895e4900b8be35d9fdc28744a6ef491c46ec8601990e12a58af0ed",
		tx.Input)
	...
	require.Nil(t, err)
	require.Equal(t,
		"0x8403c6eeef5258f02ef31b81c44d429084041d09c4277e06ee244d77d7f2d8cc",
		tx.BlockHash)
	...
	require.Equal(t,
		"0x37aa58204bf86db054dd8ebac958b39d679e3c0914cdb25cf64213bbf36f0494",
		tx.Hash)
...
func TestLogUnmarshal(t *testing.T) {
	...
	require.Equal(t,
		[]string{"0x78e4fc71ff7e525b3b4660a76336a2046232fd9bba9c65abb22fa3d07d6e7066"},
		log.Topics)
	require.Equal(t,
	...
	require.Equal(t,
		"0x3757b6efd7f82e3a832f0ec229b2fa36e622033ae7bad76b95763055a69374f7",
		log.BlockHash)
	require.Equal(t, 1, log.TransactionIndex)
	require.Equal(t,
		"0xecd8a21609fa852c08249f6c767b7097481da34b9f8d2aae70067918955b4e69",
		log.TransactionHash)
...
func TestTransactionReceiptUnmarshal(t *testing.T) {
	...
	require.Equal(t,
		"",
		receipt.LogsBloom)
	require.Equal(t,
		"0xe367ea197d629892e7b25ea246fba93cd8ae053d468cc5997a816cc85d660321",
		receipt.Root)
	require.Equal(t,
		"0xecd8a21609fa852c08249f6c767b7097481da34b9f8d2aae70067918955b4e69",
	...
	require.Equal(t, "0xd10e3be2bc8f959bc8c41cf65f60de721cf89adf",

...
// 				t.Errorf("NewArNS() = %v, want %v", got.ArNSAddress,
// 					tt.want.ArNSAddress)
// 			}
...
// 	for _, tt := range tests {
// 		t.Run(tt.name, func(t *testing.T) {
// 			a := NewArNS(tt.fields.DreUrl, tt.fields.ArNSAddress,
// 				tt.fields.Timeout)
// 			gotTxId, err := a.QueryLatestRecord(tt.args.domain)
// 			if (err != nil) != tt.wantErr {
// 				t.Errorf("QueryLatestRecord() error = %v, wantErr %v", err,
// 					tt.wantErr)
// 				return
// 			}
// 			if gotTxId != tt.wantTxId {
// 				t.Errorf("QueryLatestRecord() gotTxId = %v, want %v", gotTxId,
// 					tt.wantTxId)
// 			}
// 		})
// 	}
...
// 			if (err != nil) != tt.wantErr {
// 				t.Errorf("QueryNameCa() error = %v, wantErr %v", err,
// 					tt.wantErr)
// 				return
// 			}
// 			if gotCaAddress != tt.wantCaAddress {
// 				t.Errorf("QueryNameCa() gotCaAddress = %v, want %v",
// 					gotCaAddress, tt.wantCaAddress)
// 			}
// 		})
// 	}
// }

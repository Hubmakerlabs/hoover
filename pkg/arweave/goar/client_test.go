...
// 	assert.NoError(t, err)
// 	assert.Equal(t,
// 		"0pu7-Otb-AH6SSSX_rfUmpTkwh3Nmhpztd_IT8nYXDwBE6P3B-eJSBuaTBeLypx4",
// 		tx.LastTx)
//
// 	// not exist tx
...
// 	items, err := c.GetBundleItems("5mnFoNrXKYVESgIyk9PCVPUPYhL4y5uaxOz-ShflJQk",
// 		itemsIds)
// 	assert.NoError(t, err)
...
// 		"zlU0o99c81n0CP64F31ANpyJeOtlz5DKvsKohmbMxqU"}
// 	items, err := c.GetBundleItems("47KozLIAfVMKdxq1q3D1xFZmRpkahOOBQ8boOjSydnQ",
// 		itemsIds)
//
// 	assert.NoError(t, err)
...
// 	c := NewClient("https://arweave.net")
// 	itemsIds := []string{"QD0ryQTy4CBr7kluWRLT1strRcXWJOgUUoIYat4lk1s",
// 		"BzsIVzo6rPfGQg0PP-5Y_HErPey51_it0d6aGIUfQnY",
// 		"fy3aOYoRf7OzCEd9_WrD-RfqbzNZ1LsJ4PKIIGUALik"}
// 	items, err := c.GetBundleItems("PRBVxEX00aVMN59EY8gznt83FTlGXZvESwv1WTP7ReQ",
// 		itemsIds)
//
// 	assert.NoError(t, err)
// 	assert.Equal(t, 3, len(items))
...
// 			t.Log("found item")
// 			t.Log("item start offset", "offset", bundleItemStart, "length",
// 				itemBinaryLength)

...
// func assemblyDataTx(bigData []byte, wallet *goar.Wallet,
...
//
// 	tags := []types.Tag{{Name: "Content-Type", Value: "application/pdf"},
// 		{Name: "goar", Value: "testdata"}}
...
// 	assert.NoError(t, err)
//
// 	tags := []types.Tag{{Name: "Content-Type", Value: "application/jpg"},
// 		{Name: "goar", Value: "testdata"}}
//
// 	tx, err := assemblyDataTx(bigData, wallet, tags)
// 	assert.NoError(t, err)
...
// 	newUploader, err := goar.CreateUploader(wallet.Client,
// 		lastUploader.FormatSerializedUploader(), bigData)
// 	assert.NoError(t, err)

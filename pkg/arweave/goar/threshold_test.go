...
func TestCreateTcKeyPair(t *testing.T) {
	...
	// verify
	err = rsa.VerifyPSS(keyMeta.PublicKey, crypto.SHA256, signHashed[:],
		signature123, nil)
	if err != nil {
		panic(err)
	}
	...
	assert.EqualError(t, err,
		"insufficient number of signature shares. provided: 2, needed: 3")
...
// GetKeyPairByLocal
func GetKeyPairFormLocalFile() (shares tcrsa.KeyShareList, meta *tcrsa.KeyMeta,
	err error) {

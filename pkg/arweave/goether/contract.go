...
func NewContract(address common.Address, abiStr, rpc string,
	wallet *Wallet) (*Contract, error) {
...
func (c *Contract) CallMethod(methodName, tag string,
	args ...interface{}) (res string, err error) {
...
func (c *Contract) ExecMethod(methodName string, opts *TxOpts,
	args ...interface{}) (txHash string, err error) {
	if c.Wallet == nil {
...
func (c *Contract) EncodeData(methodName string, args ...interface{}) ([]byte,
	error) {
	return c.ABI.Pack(methodName, args...)
}

func (c *Contract) EncodeDataHex(methodName string,
	args ...interface{}) (hex string, err error) {
...
func (c *Contract) DecodeData(data []byte) (methodName string,
...
func (c *Contract) DecodeDataHex(dataHex string) (methodName string,
	params map[string]interface{}, err error) {
	data := common.FromHex(dataHex)
	return c.DecodeData(data)
}

func (c *Contract) DecodeEvent(topics []common.Hash,
	data []byte) (eventName string, values map[string]interface{}, err error) {
	if len(topics) < 1 {
...
func (c *Contract) DecodeEventHex(topicsHex []string,
	dataHex string) (eventName string, values map[string]interface{},
	err error) {

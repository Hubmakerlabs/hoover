...
func TestAddress(t *testing.T) {
	assert.Equal(t, "0xab6c371B6c466BcF14d4003601951e5873dF2AcA",
		TestSigner.Address.String())
}

func TestSignTx(t *testing.T) {
	tx, err := TestSigner.SignTx(1,
		common.HexToAddress("0xab6c371B6c466BcF14d4003601951e5873dF2AcA"),
		big.NewInt(0), 21000, big.NewInt(100000000000),
		big.NewInt(100000000000), nil, big.NewInt(42))
	assert.NoError(t, err)
	assert.Equal(t, big.NewInt(42), tx.ChainId())
	tx, err = TestSigner.SignLegacyTx(1,
		common.HexToAddress("0xab6c371B6c466BcF14d4003601951e5873dF2AcA"),
		big.NewInt(0), 21000, big.NewInt(100000000000), nil, big.NewInt(42))
	assert.NoError(t, err)
	assert.Equal(t, big.NewInt(42), tx.ChainId())
}
...
func TestSignMsg(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.Equal(t,
		"0x409c16579b4fc162f199f897497f5142101992af82cc6a0b9521413cf721151817e52781c0341fa333cdfea6ebe945b9231f8a8b3df7e7040203f9d7df26c2f21c",
		hexutil.Encode(sig))
}
...
// 	assert.NoError(t, err)
// 	assert.Equal(t,
// 		"0x0a80cc322f7a5e5e0965ff84fd76ea6479fae9d8ce29f7e076c3b9cb8e8097b80052ee91f1fad54d4348c518e42395848431746c8fee40420041f87ea05b5a281c",
// 		hexutil.Encode(sig))
//

...
func TestEIP712(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.Equal(t,
		"0xcf3985dd9eb11ce656eafc2dddd08ce3058ad00c74669b3d171f31e9a0472d8e",
		hexutil.Encode(hash))

	_, addr, err := Ecrecover(hash,
		hexutil.MustDecode("0xa9a3e5f72b48651b735d0908f1f240b06eafe7166dbe6b4fc8b57d8b8515ef555fe4b124c2b50d6907423426ec46bc12c5956942dcfd01e02d70912c87a389c41b"))
	assert.NoError(t, err)
...
func TestEcrecover(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.Equal(t, "0xcba9f09e7e6b4a41a9d11f347416b75ee100344f",

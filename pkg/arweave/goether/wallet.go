...
func (w *Wallet) SendTx(to common.Address, amount *big.Int, data []byte,
	opts *TxOpts) (txHash string, err error) {
...
func (w *Wallet) SendLegacyTx(to common.Address, amount *big.Int, data []byte,
	opts *TxOpts) (txHash string, err error) {
	opts, err = w.initTxOpts(to, amount, data, opts)
	if err != nil {
		return
...
func (w *Wallet) initTxOpts(to common.Address, amount *big.Int, data []byte,
	opts *TxOpts) (*TxOpts, error) {
	var (
		nonce, gasLimit int
		gasPrice        big.Int
		err             error

...
//
// 	rootPath := "./dist"
// 	orders, manifestId, everTxs, err := sdk.UploadFolderAndPay(rootPath, 20,
// 		"index.html", "usdt")
// 	assert.NoError(t, err)
// 	t.Log(len(orders))
...
//
// 	rootPath := "./dist"
// 	orders, manifestId, err := sdk.UploadFolder(rootPath, 20, "index.html",
// 		"usdt")
// 	assert.NoError(t, err)
// 	t.Log(len(orders))
// 	t.Log("manifestId:", manifestId)
...
//
// 	rootPath := "./build"
// 	orders, manifestId, err := sdk.UploadFolderWithNoFee(rootPath, 20,
// 		"index.html", apikey)
// 	assert.NoError(t, err)
// 	t.Log(len(orders))
// 	t.Log("manifestId:", manifestId)

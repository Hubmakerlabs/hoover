...
Please see [Releases](https://github.com/Hubmakerlabs/hoover/pkg/eth/releases). We recommend using the [most recently released version](https://github.com/Hubmakerlabs/hoover/pkg/eth/releases/latest).

## Audit reports

Audit reports are published in the `docs` folder: https://github.com/Hubmakerlabs/hoover/pkg/eth/tree/master/docs/audits 
...
To find out how to disclose a vulnerability in Ethereum visit [https://bounty.ethereum.org](https://bounty.ethereum.org) or email bounty@ethereum.org. Please read the [disclosure page](https://github.com/Hubmakerlabs/hoover/pkg/eth/security/advisories?state=published) for more information about publicly disclosed security vulnerabilities.

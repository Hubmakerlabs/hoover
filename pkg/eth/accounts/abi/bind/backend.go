...
type ContractCaller interface {
	...
	CodeAt(ctx context.Context, contract common.Address,
		blockNumber *big.Int) ([]byte, error)

	// CallContract executes an Ethereum contract call with the specified data as the
	// input.
	CallContract(ctx context.Context, call ethereum.CallMsg,
		blockNumber *big.Int) ([]byte, error)
}
...
type PendingContractCaller interface {
	...
	PendingCallContract(ctx context.Context, call ethereum.CallMsg) ([]byte,
		error)
}
...
type BlockHashContractCaller interface {
	...
	CodeAtHash(ctx context.Context, contract common.Address,
	...
	CallContractAtHash(ctx context.Context, call ethereum.CallMsg,
		blockHash common.Hash) ([]byte, error)
}
...
type ContractTransactor interface {
	...
	EstimateGas(ctx context.Context, call ethereum.CallMsg) (gas uint64,
		err error)
...
type ContractFilterer interface {
	...
	FilterLogs(ctx context.Context, query ethereum.FilterQuery) ([]types.Log,
		error)

...
func genIntType(rule int64, size uint) []byte {
	...
	if rule < 0 {
		...
		topic = [common.HashLength]byte{255, 255, 255, 255, 255, 255, 255, 255,
...
func ParseTopics(out interface{}, fields Arguments,
	topics []common.Hash) error {
...
func ParseTopicsIntoMap(out map[string]interface{}, fields Arguments,
	topics []common.Hash) error {
	return parseTopicWithSetter(fields, topics,
		func(arg Argument, reconstr interface{}) {
...
func parseTopicWithSetter(fields Arguments, topics []common.Hash,
	setter func(Argument, interface{})) error {
	...
	for i, arg := range fields {
		...
		case FunctionTy:
			if garbage := binary.BigEndian.Uint64(topics[i][0:8]); garbage != 0 {
				return fmt.Errorf("bind: got improperly encoded function type, got %v",
					topics[i].Bytes())
			}
			var tmp [24]byte

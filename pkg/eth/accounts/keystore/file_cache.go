...
func (fc *fileCache) scan(keyDir string) (mapset.Set[string],
	mapset.Set[string], mapset.Set[string], error) {
	t0 := time.Now()
	...
	log.Debug("FS scan times", "list", t1.Sub(t0), "set", t2.Sub(t1), "diff",
		t3.Sub(t2))

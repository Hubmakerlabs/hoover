...
func runMinimalGeth(t *testing.T, args ...string) *testgeth {
	...
	allArgs := []string{"--goerli", "--networkid", "1337", "--authrpc.port",
		"0", "--syncmode=full", "--port", "0",
...
func TestConsoleWelcome(t *testing.T) {
	...
	geth.SetTemplateFunc("gethver",
		func() string { return params.VersionWithCommit("", "") })
	geth.SetTemplateFunc("niltime", func() string {
		return time.Unix(1548854791,
			0).Format("Mon Jan 02 2006 15:04:05 GMT-0700 (MST)")
	})
...
func TestAttachWelcome(t *testing.T) {
	...
	geth := runMinimalGeth(t, "--miner.etherbase",
...
func testAttachWelcome(t *testing.T, geth *testgeth, endpoint, apis string) {
	...
	attach.SetTemplateFunc("gethver",
		func() string { return params.VersionWithCommit("", "") })
	...
	attach.SetTemplateFunc("ipc",
		func() bool { return strings.HasPrefix(endpoint, "ipc") })

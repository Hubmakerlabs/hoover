...
import (
	...
	"github.com/Hubmakerlabs/hoover/pkg/eth/cmd/evm/internal/compiler"
	...
	"github.com/Hubmakerlabs/hoover/pkg/eth/core/vm/runtime"
...
func timedExec(bench bool,
	execFunc func() ([]byte, uint64, error)) (output []byte, gasLeft uint64,
	stats execStats, err error) {
	if bench {

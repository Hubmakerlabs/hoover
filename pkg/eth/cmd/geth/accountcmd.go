...
func unlockAccount(ks *keystore.KeyStore, address string, i int,
	...
	for trials := 0; trials < 3; trials++ {
		prompt := fmt.Sprintf("Unlocking account %s | Attempt %d/%d", address,
			trials+1, 3)
...
func ambiguousAddrRecovery(ks *keystore.KeyStore,
	err *keystore.AmbiguousAddrError, auth string) accounts.Account {
...
func accountCreate(ctx *cli.Context) error {
	...
	password := utils.GetPassPhraseWithList("Your new account is locked with a password. Please give a password. Do not forget this password.",
...
func accountUpdate(ctx *cli.Context) error {
	...
	for _, addr := range ctx.Args().Slice() {
		...
		newPassword := utils.GetPassPhraseWithList("Please give a new password. Do not forget this password.",
			true, 0, nil)
...
func importWallet(ctx *cli.Context) error {
	...
	ks := backends[0].(*keystore.KeyStore)
	passphrase := utils.GetPassPhraseWithList("", false, 0,
...
func accountImport(ctx *cli.Context) error {
	...
	ks := backends[0].(*keystore.KeyStore)
	passphrase := utils.GetPassPhraseWithList("Your new account is locked with a password. Please give a password. Do not forget this password.",
		true, 0, utils.MakePasswordList(ctx))

...
import (
	...
	"github.com/Hubmakerlabs/hoover/pkg/eth/console"
...
See https://geth.ethereum.org/docs/interacting-with-geth/javascript-console.`,
	...
	attachCommand = &cli.Command{
		...
		Flags: flags.Merge([]cli.Flag{utils.DataDirFlag,
			utils.HttpHeaderFlag}, consoleFlags),
		Description: `
The Geth console is an interactive shell for the JavaScript runtime environment
which exposes a node admin interface as well as the Ðapp JavaScript API.
See https://geth.ethereum.org/docs/interacting-with-geth/javascript-console.
...
func remoteConsole(ctx *cli.Context) error {
	...
	client, err := utils.DialRPCWithHeaders(endpoint,
		ctx.StringSlice(utils.HttpHeaderFlag.Name))
	if err != nil {

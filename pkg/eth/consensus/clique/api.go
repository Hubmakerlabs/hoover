...
func (api *API) GetSigners(number *rpc.BlockNumber) ([]common.Address, error) {
	...
	snap, err := api.clique.snapshot(api.chain, header.Number.Uint64(),
		header.Hash(), nil)
	if err != nil {
		return nil, err
	}
...
func (api *API) GetSigner(rlpOrBlockNr *blockNumberOrHashOrRLP) (common.Address,
	error) {
	if len(rlpOrBlockNr.RLP) == 0 {
		...
		if header == nil {
			return common.Address{}, fmt.Errorf("missing block %v",

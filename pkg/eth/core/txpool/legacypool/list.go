...
func (l *list) Add(tx *types.Transaction, priceBump uint64) (bool,
	*types.Transaction) {
...
func (l *list) Filter(costLimit *big.Int, gasLimit uint64) (types.Transactions,
	types.Transactions) {
...
func (l *pricedList) Discard(slots int, force bool) (types.Transactions, bool) {
	drop := make(types.Transactions, 0,
		slots) // Remote underpriced transactions to drop
	for slots > 0 {

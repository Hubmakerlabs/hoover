...
func TestBlockEncoding(t *testing.T) {
	...
	check("Coinbase", block.Coinbase(),
		common.HexToAddress("8888f1f195afa192cfee860698584c030f4c9db1"))
	check("MixDigest", block.MixDigest(),
		common.HexToHash("bd4472abb6659ebe3ee06ee4d7b72a00a9f4d001caca51342001075469aff498"))
	check("Root", block.Root(),
		common.HexToHash("ef1552a40b7165c3cd773806b9e0c165b75356e0314bf0706f279c729f51e017"))
	check("Hash", block.Hash(),
		common.HexToHash("0a5843ac1cb04865017cb35a57b50b07084e5fcee39b5acadade33149f4fff9e"))
	...
	tx1 := NewTransaction(0,
		...
		big.NewInt(10), 50000, big.NewInt(10), nil)
...
func TestEIP1559BlockEncoding(t *testing.T) {
	...
	check("Root", block.Root(),
		common.HexToHash("ef1552a40b7165c3cd773806b9e0c165b75356e0314bf0706f279c729f51e017"))
	check("Hash", block.Hash(),
		common.HexToHash("c7252048cd273fe0dac09650027d07f0e3da4ee0675ebbb26627cea92729c372"))
	check("Nonce", block.Nonce(), uint64(0xa13a5a8c8f2bb1c4))
	check("Time", block.Time(), uint64(1426516743))
	check("Size", block.Size(), uint64(len(blockEnc)))
	check("BaseFee", block.BaseFee(),
	...
	tx2 := NewTx(txdata)
	tx2, err := tx2.WithSignature(LatestSignerForChainID(big.NewInt(1)),
...
func TestEIP2718BlockEncoding(t *testing.T) {
	...
	tx2 := NewTx(&AccessListTx{
		...
		Gas:      123457,
		GasPrice: big.NewInt(10),
		AccessList: AccessList{{Address: addr,
	...
	check("Transactions[0].Hash", block.Transactions()[0].Hash(), tx1.Hash())
	check("Transactions[1].Hash", block.Transactions()[1].Hash(), tx2.Hash())
	check("Transactions[1].Type()", block.Transactions()[1].Type(),
		uint8(AccessListTxType))
...
func makeBenchBlock() *Block {
	...
	for i := range txs {
		...
		data := make([]byte, 100)
		tx := NewTransaction(uint64(i), common.Address{}, amount, 123457, price,
			data)

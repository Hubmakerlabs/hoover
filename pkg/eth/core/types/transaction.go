...
func sanityCheckSignature(v *big.Int, r *big.Int, s *big.Int,
	maybeProtected bool) error {
...
func (tx *Transaction) Cost() *big.Int {
	...
	if tx.Type() == BlobTxType {
		total.Add(total, new(big.Int).Mul(tx.BlobGasFeeCap(),
...
func (tx *Transaction) EffectiveGasTipCmp(other *Transaction,
	baseFee *big.Int) int {
	if baseFee == nil {
...
func (tx *Transaction) EffectiveGasTipIntCmp(other *big.Int,
	baseFee *big.Int) int {
	if baseFee == nil {

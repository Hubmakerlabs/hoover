...
func ckzgInit() {
	...
	g1s := make([]byte,
		len(params.SetupG1Lagrange)*(len(params.SetupG1Lagrange[0])-2)/2)
...
func ckzgComputeProof(blob Blob, point Point) (Proof, Claim, error) {
	...
	proof, claim, err := ckzg4844.ComputeKZGProof((ckzg4844.Blob)(blob),
...
func ckzgVerifyProof(commitment Commitment, point Point, claim Claim,
	proof Proof) error {
	ckzgIniter.Do(ckzgInit)

	valid, err := ckzg4844.VerifyKZGProof((ckzg4844.Bytes48)(commitment),
		(ckzg4844.Bytes32)(point), (ckzg4844.Bytes32)(claim),
...
func ckzgComputeBlobProof(blob Blob, commitment Commitment) (Proof, error) {
	...
	proof, err := ckzg4844.ComputeBlobKZGProof((ckzg4844.Blob)(blob),
...
func ckzgVerifyBlobProof(blob Blob, commitment Commitment, proof Proof) error {
	...
	valid, err := ckzg4844.VerifyBlobKZGProof((ckzg4844.Blob)(blob),
		(ckzg4844.Bytes48)(commitment), (ckzg4844.Bytes48)(proof))
	if err != nil {
		return err
	}
	if !valid {

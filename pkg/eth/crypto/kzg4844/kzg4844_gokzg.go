...
func gokzgBlobToCommitment(blob Blob) (Commitment, error) {
	...
	bl := (gokzg4844.Blob)(blob)
	commitment, err := context.BlobToKZGCommitment(&bl, 0)
	if err != nil {
...
func gokzgComputeProof(blob Blob, point Point) (Proof, Claim, error) {
	...
	bl := (gokzg4844.Blob)(blob)
	proof, claim, err := context.ComputeKZGProof(&bl, (gokzg4844.Scalar)(point),
		0)
	if err != nil {
...
func gokzgVerifyProof(commitment Commitment, point Point, claim Claim,
	proof Proof) error {
	gokzgIniter.Do(gokzgInit)

	return context.VerifyKZGProof((gokzg4844.KZGCommitment)(commitment),
		(gokzg4844.Scalar)(point), (gokzg4844.Scalar)(claim),
...
func gokzgComputeBlobProof(blob Blob, commitment Commitment) (Proof, error) {
	...
	bl := (gokzg4844.Blob)(blob)
	proof, err := context.ComputeBlobKZGProof(&bl,
		(gokzg4844.KZGCommitment)(commitment), 0)
	if err != nil {
		return Proof{}, err
	}
...
func gokzgVerifyBlobProof(blob Blob, commitment Commitment, proof Proof) error {
	...
	bl := (gokzg4844.Blob)(blob)
	return context.VerifyBlobKZGProof(&bl,
		(gokzg4844.KZGCommitment)(commitment), (gokzg4844.KZGProof)(proof))
}

...
type Peer interface {
	...
	RequestHeadersByHash(common.Hash, int, int, bool,
		chan *eth.Response) (*eth.Request, error)
	RequestHeadersByNumber(uint64, int, int, bool,
		chan *eth.Response) (*eth.Request, error)
...
func newPeerConnection(id string, version uint, peer Peer,
	logger log.Logger) *peerConnection {
...
func (p *peerConnection) UpdateHeaderRate(delivered int,
...
func (p *peerConnection) UpdateReceiptRate(delivered int,
	elapsed time.Duration) {
...
func (ps *peerSet) Register(p *peerConnection) error {
	...
	p.rates = msgrate.NewTracker(ps.rates.MeanCapacities(),
		ps.rates.MedianRoundTrip())

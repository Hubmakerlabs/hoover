...
func newFourByteTracer(ctx *tracers.Context, _ json.RawMessage) (tracers.Tracer,
	error) {
	t := &fourByteTracer{
...
func (t *fourByteTracer) CaptureStart(env *vm.EVM, from common.Address,
...
func (t *fourByteTracer) CaptureEnter(op vm.OpCode, from common.Address,

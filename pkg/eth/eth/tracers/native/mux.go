...
func newMuxTracer(ctx *tracers.Context, cfg json.RawMessage) (tracers.Tracer,
	error) {
...
func (t *muxTracer) CaptureStart(env *vm.EVM, from common.Address,
...
func (t *muxTracer) CaptureState(pc uint64, op vm.OpCode, gas, cost uint64,
...
func (t *muxTracer) CaptureFault(pc uint64, op vm.OpCode, gas, cost uint64,
...
func (t *muxTracer) CaptureEnter(typ vm.OpCode, from common.Address,

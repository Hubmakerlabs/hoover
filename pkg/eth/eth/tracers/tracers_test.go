...
func BenchmarkTransactionTrace(b *testing.B) {
	...
	triedb, _, statedb := tests.MakePreState(rawdb.NewMemoryDatabase(), alloc,
	...
	evm := vm.NewEVM(context, txContext, statedb,
		params.AllEthashProtocolChanges, vm.Config{Tracer: tracer})
...
func TestMemCopying(t *testing.T) {
	for i, tc := range []struct {
		...
		{0, 1, 1024*1024 + 1, "reached limit for padding memory slice: 1048578",
			0}, // Errror
		{10, 0, 1024*1024 + 100,
			"reached limit for padding memory slice: 1048666", 0}, // Errror

...
func (db *Database) AncientRange(kind string,
...
func (db *Database) ModifyAncients(f func(ethdb.AncientWriteOp) error) (int64,
	error) {
	panic("not supported")
}
...
func (db *Database) MigrateTable(s string,
	f func([]byte) ([]byte, error)) error {
	panic("not supported")
}

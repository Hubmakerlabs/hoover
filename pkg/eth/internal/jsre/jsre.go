...
func (re *JSRE) runEventLoop() {
	...
	newTimer := func(call goja.FunctionCall, interval bool) (*jsTimer,
		goja.Value) {
...
func MakeCallback(vm *goja.Runtime,
	fn func(Call) (goja.Value, error)) goja.Value {
...
func (re *JSRE) loadScript(call Call) (goja.Value, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("error while compiling or running script: %v",
			err)
	}
	return value, nil
}

func compileAndRun(vm *goja.Runtime, filename string, src string) (goja.Value,
	error) {

...
func (ltrx *lesTxRelay) send(txs types.Transactions, count int) {
	...
	for p, list := range sendTo {
		...
		go ltrx.retriever.retrieve(context.Background(), reqID, rq,
			func(p distPeer, msg *Msg) error { return nil }, ltrx.stop)
	}
}
...
func (ltrx *lesTxRelay) NewHead(head common.Hash, mined []common.Hash,

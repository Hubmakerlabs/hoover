...
func NewWrsIterator(ns *nodestate.NodeStateMachine,
	requireFlags, disableFlags nodestate.Flags,
	weightField nodestate.Field) *WrsIterator {
	...
	ns.SubscribeField(weightField, func(n *enode.Node, state nodestate.Flags,

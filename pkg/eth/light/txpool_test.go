...
func (r *testTxRelay) NewHead(head common.Hash, mined []common.Hash,
...
func TestTxPool(t *testing.T) {
	for i := range testTx {
		testTx[i], _ = types.SignTx(types.NewTransaction(uint64(i), acc1Addr,
			big.NewInt(10000), params.TxGas, big.NewInt(params.InitialBaseFee),
			nil), types.HomesteadSigner{}, testBankKey)
	}
	...
	_, gchain, _ := core.GenerateChainWithGenesis(gspec, ethash.NewFaker(),
		poolTestBlocks, txPoolTestChainGen)

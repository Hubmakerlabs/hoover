...
import (
	...
	"github.com/Hubmakerlabs/hoover/pkg/eth/metrics/prometheus"
)
...
func (exp *exp) publishCounterFloat64(name string,
	metric metrics.CounterFloat64Snapshot) {
	v := exp.getFloat(name)
	v.Set(metric.Count())
}
...
func (exp *exp) publishGaugeFloat64(name string,
	metric metrics.GaugeFloat64Snapshot) {
	exp.getFloat(name).Set(metric.Value())
}

func (exp *exp) publishGaugeInfo(name string,
	metric metrics.GaugeInfoSnapshot) {
...
func (exp *exp) publishResettingTimer(name string,
	metric metrics.ResettingTimer) {
	t := metric.Snapshot()

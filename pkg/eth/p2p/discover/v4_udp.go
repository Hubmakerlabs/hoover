...
import (
	...
	"github.com/Hubmakerlabs/hoover/pkg/eth/p2p/discover/v4wire"
...
func (t *UDPv4) sendPing(toid enode.ID, toaddr *net.UDPAddr,
	callback func()) *replyMatcher {
	...
	rm := t.pending(toid, toaddr.IP, v4wire.PongPacket,
		func(p v4wire.Packet) (matched bool, requestDone bool) {
...
func (t *UDPv4) findnode(toid enode.ID, toaddr *net.UDPAddr,
	target v4wire.Pubkey) ([]*node, error) {
	...
	rm := t.pending(toid, toaddr.IP, v4wire.NeighborsPacket,
		func(r v4wire.Packet) (matched bool, requestDone bool) {
			...
			for _, rn := range reply.Nodes {
				...
				if err != nil {
					t.log.Trace("Invalid neighbor node received", "ip", rn.IP,
						"addr", toaddr, "err", err)
					continue
				}
...
func (t *UDPv4) RequestENR(n *enode.Node) (*enode.Node, error) {
	...
	rm := t.pending(n.ID(), addr.IP, v4wire.ENRResponsePacket,
		func(r v4wire.Packet) (matched bool, requestDone bool) {
	...
	respN, err := enode.New(enode.ValidSchemes,
		&rm.reply.(*v4wire.ENRResponse).Record)
	if err != nil {
		return nil, err
	}
	if respN.ID() != n.ID() {
...
func (t *UDPv4) pending(id enode.ID, ip net.IP, ptype byte,
	callback replyMatchFunc) *replyMatcher {
	ch := make(chan error, 1)
	p := &replyMatcher{from: id, ip: ip, ptype: ptype, callback: callback,
		errc: ch}
	select {
...
func (t *UDPv4) handleReply(from enode.ID, fromIP net.IP,
	req v4wire.Packet) bool {
...
func (t *UDPv4) send(toaddr *net.UDPAddr, toid enode.ID,
	req v4wire.Packet) ([]byte, error) {
	packet, hash, err := v4wire.Encode(t.priv, req)
	if err != nil {
		return hash, err
	}
...
func (t *UDPv4) write(toaddr *net.UDPAddr, toid enode.ID, what string,
	packet []byte) error {
...
func (t *UDPv4) ensureBond(toid enode.ID, toaddr *net.UDPAddr) {
	tooOld := time.Since(t.db.LastPingReceived(toid,
		toaddr.IP)) > bondExpiration
...
func (t *UDPv4) nodeFromRPC(sender *net.UDPAddr, rn v4wire.Node) (*node,
	error) {
	if rn.UDP <= 1024 {
...
func nodeToRPC(n *node) v4wire.Node {
	...
	return v4wire.Node{ID: ekey, IP: n.IP(), UDP: uint16(n.UDP()),
		TCP: uint16(n.TCP())}
}
...
type packetHandlerV4 struct {
	...
	preverify func(p *packetHandlerV4, from *net.UDPAddr, fromID enode.ID,
		fromKey v4wire.Pubkey) error
	// handle handles the packet.
	handle func(req *packetHandlerV4, from *net.UDPAddr, fromID enode.ID,
		mac []byte)
}

// PING/v4

func (t *UDPv4) verifyPing(h *packetHandlerV4, from *net.UDPAddr,
	fromID enode.ID, fromKey v4wire.Pubkey) error {
...
func (t *UDPv4) handlePing(h *packetHandlerV4, from *net.UDPAddr,
	...
	n := wrapNode(enode.NewV4(h.senderKey, from.IP, int(req.From.TCP),
		from.Port))
	...
	t.localNode.UDPEndpointStatement(from,
		&net.UDPAddr{IP: req.To.IP, Port: int(req.To.UDP)})
}

// PONG/v4

func (t *UDPv4) verifyPong(h *packetHandlerV4, from *net.UDPAddr,
	fromID enode.ID, fromKey v4wire.Pubkey) error {
...
func (t *UDPv4) verifyFindnode(h *packetHandlerV4, from *net.UDPAddr,
	fromID enode.ID, fromKey v4wire.Pubkey) error {
...
func (t *UDPv4) handleFindnode(h *packetHandlerV4, from *net.UDPAddr,
	fromID enode.ID, mac []byte) {
	req := h.Packet.(*v4wire.Findnode)
...
func (t *UDPv4) verifyNeighbors(h *packetHandlerV4, from *net.UDPAddr,
	fromID enode.ID, fromKey v4wire.Pubkey) error {
...
func (t *UDPv4) verifyENRRequest(h *packetHandlerV4, from *net.UDPAddr,
	fromID enode.ID, fromKey v4wire.Pubkey) error {
...
func (t *UDPv4) handleENRRequest(h *packetHandlerV4, from *net.UDPAddr,
	fromID enode.ID, mac []byte) {
...
func (t *UDPv4) verifyENRResponse(h *packetHandlerV4, from *net.UDPAddr,
	fromID enode.ID, fromKey v4wire.Pubkey) error {
	if !t.handleReply(fromID, from.IP, h.Packet) {
		return errUnsolicitedReply
	}

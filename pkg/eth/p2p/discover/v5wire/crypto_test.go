...
func TestVector_ECDH(t *testing.T) {
	var (
		...
		publicKey = hexPubkey(crypto.S256(),
...
func TestVector_KDF(t *testing.T) {
	...
	s := deriveKeys(sha256.New, ephKey, destKey, net.nodeA.id(), net.nodeB.id(),
		cdata)
	...
	check(t, "initiator-key", s.writeKey,
		hexutil.MustDecode("0xdccc82d81bd610f4f76d3ebe97a40571"))
	check(t, "recipient-key", s.readKey,
		hexutil.MustDecode("0xac74bb8773749920b0d3a8881c173ec5"))
}

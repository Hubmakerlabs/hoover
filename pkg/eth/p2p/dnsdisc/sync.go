...
func (ct *clientTree) syncRandom(ctx context.Context) (n *enode.Node,
	err error) {
	if ct.rootUpdateDue() {
...
func (ct *clientTree) syncNextRandomENR(ctx context.Context) (*enode.Node,
	error) {
...
func newSubtreeSync(c *Client, loc *linkEntry, root string,
	link bool) *subtreeSync {
...
func (ts *subtreeSync) resolveNext(ctx context.Context, hash string) (entry,
	error) {

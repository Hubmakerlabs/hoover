...
func (s *SimAdapter) Dial(ctx context.Context, dest *enode.Node) (conn net.Conn,
	err error) {
...
func (sn *SimNode) ServeRPC(conn *websocket.Conn) error {
	...
	codec := rpc.NewFuncCodec(conn,
		func(v any, _ bool) error { return conn.WriteJSON(v) }, conn.ReadJSON)

...
var encTests = []encTest{
	...
	{
		val: []string{"aaa", "bbb", "ccc", "ddd", "eee", "fff", "ggg", "hhh",
	...
	{
		val: []interface{}{uint(1), uint(0xFFFFFF),
			[]interface{}{[]uint{4, 5, 5}}, "abc"},
	...
	{val: &optionalAndTailField{A: 1, Tail: []uint{5, 6}},
		output: "C401800506"},
	{val: &optionalAndTailField{A: 1, Tail: []uint{5, 6}},
		output: "C401800506"},
	...
	{val: &multipleOptionalFields{A: &[3]byte{1, 2, 3}, B: &[3]byte{1, 2, 3}},
		output: "C88301020383010203"},
	{val: &multipleOptionalFields{A: nil, B: &[3]byte{1, 2, 3}},
		output: "C58083010203"}, // encodes without error but decode will fail
	{val: &nonOptionalPtrField{A: 1},
		output: "C20180"}, // encodes without error but decode will fail
	...
	// interfaces
	{val: []io.Reader{reader},
		output: "C3C20102"}, // the contained value is a struct
	...
	{val: &struct{ TE testEncoder }{testEncoder{}},
		output: "CA00010001000100010001"},
	{val: &struct{ TE testEncoder }{testEncoder{errors.New("test error")}},
		error: "test error"},

	// Verify the error for non-addressable non-pointer Encoder.
	{val: testEncoder{},
		error: "rlp: unaddressable value of type rlp.testEncoder, EncodeRLP is pointer method"},

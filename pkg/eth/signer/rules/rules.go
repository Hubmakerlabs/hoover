...
import (
	...
	"github.com/Hubmakerlabs/hoover/pkg/eth/internal/jsre/deps"
...
func NewRuleEvaluator(next core.UIClientAPI,
	jsbackend storage.Storage) (*rulesetUI, error) {
	c := &rulesetUI{
		next:    next,
		storage: jsbackend,
		jsRules: "",
...
func (r *rulesetUI) execute(jsfunc string, jsarg interface{}) (goja.Value,
	error) {
...
func (r *rulesetUI) checkApproval(jsfunc string, jsarg []byte, err error) (bool,
	error) {
	if err != nil {
		return false, err
	}
...
func (r *rulesetUI) ApproveTx(request *core.SignTxRequest) (core.SignTxResponse,
	error) {
...
func (r *rulesetUI) ApproveSignData(request *core.SignDataRequest) (core.SignDataResponse,
	error) {
	jsonreq, err := json.Marshal(request)
...
func (r *rulesetUI) OnInputRequired(info core.UserInputRequest) (core.UserInputResponse,
	error) {
	return r.next.OnInputRequired(info)
}

func (r *rulesetUI) ApproveListing(request *core.ListRequest) (core.ListResponse,
	error) {
	jsonreq, err := json.Marshal(request)
...
func (r *rulesetUI) ApproveNewAccount(request *core.NewAccountRequest) (core.NewAccountResponse,
	error) {

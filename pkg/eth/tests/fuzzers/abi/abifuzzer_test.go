...
var (
	names = []string{"_name", "name", "NAME", "name_", "__",
		"_name_", "n"}
	stateMut         = []string{"", "pure", "view", "payable"}
	stateMutabilites = []*string{&stateMut[0], &stateMut[1], &stateMut[2],
		&stateMut[3]}
	...
	varTypes = []string{"bool", "address", "bytes", "string",
		...
		"uint24", "int24", "uint32", "int32", "uint40", "int40", "uint48",
		"int48", "uint56", "int56",
		"uint64", "int64", "uint72", "int72", "uint80", "int80", "uint88",
		"int88", "uint96", "int96",
		"uint104", "int104", "uint112", "int112", "uint120", "int120",
		"uint128", "int128", "uint136", "int136",
		"uint144", "int144", "uint152", "int152", "uint160", "int160",
		"uint168", "int168", "uint176", "int176",
		"uint184", "int184", "uint192", "int192", "uint200", "int200",
		"uint208", "int208", "uint216", "int216",
		"uint224", "int224", "uint232", "int232", "uint240", "int240",
		"uint248", "int248", "uint256", "int256",
		...
		"bytes18", "bytes19", "bytes20", "bytes21",
		"bytes22", "bytes23", "bytes24", "bytes25", "bytes26", "bytes27",
		"bytes28", "bytes29", "bytes30", "bytes31",
		"bytes32", "bytes"}
)

func unpackPack(abi abi.ABI, method string, input []byte) ([]interface{},
	bool) {
...
func createABI(name string, stateMutability, payable *string,
	inputs []args) (abi.ABI, error) {
	...
	if len(inputs) > 0 {
		...
		for i, inp := range inputs {
			sig += fmt.Sprintf(`"name" : "%v", "type" : "%v" `, inp.name,
				inp.typ)
			if i+1 < len(inputs) {
				sig += ","
			}

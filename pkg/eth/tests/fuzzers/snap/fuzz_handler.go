...
func getChain() *core.BlockChain {
	...
	_, blocks, _ := core.GenerateChainWithGenesis(gspec, ethash.NewFaker(), 2,
	...
	bc, _ := core.NewBlockChain(rawdb.NewMemoryDatabase(), cacheConf, gspec,
		nil, ethash.NewFaker(), vm.Config{}, nil, nil)

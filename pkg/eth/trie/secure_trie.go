...
func NewSecure(stateRoot common.Hash, owner common.Hash, root common.Hash,
	db *Database) (*SecureTrie, error) {
	id := &ID{
		StateRoot: stateRoot,
		Owner:     owner,
		Root:      root,
...
// If a trie node is not found in the database, a MissingNodeError is returned.
func (t *StateTrie) GetAccount(address common.Address) (*types.StateAccount,
	error) {
...
func (t *StateTrie) GetAccountByHash(addrHash common.Hash) (*types.StateAccount,
	error) {
...
func (t *StateTrie) UpdateAccount(address common.Address,
...
func (t *StateTrie) UpdateContractCode(_ common.Address, _ common.Hash,
	_ []byte) error {
	return nil
}

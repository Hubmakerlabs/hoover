...
type StackTrieOptions struct {
	Writer func(path []byte, hash common.Hash,
		blob []byte) // The function to commit the dirty nodes
...
func (o *StackTrieOptions) WithWriter(writer func(path []byte, hash common.Hash,
	blob []byte)) *StackTrieOptions {
	o.Writer = writer
	return o
}
...
func (o *StackTrieOptions) WithSkipBoundary(skipLeft, skipRight bool,
	gauge metrics.Gauge) *StackTrieOptions {
